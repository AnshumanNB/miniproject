      ...
      <div className="hero-section container d-flex align-items-center justify-content-between">
        ...
        >
          ...
          <motion.div className="hero-actions" variants={itemVariants + " d-flex flex-wrap gap-3"}>
            <Link to="/login" className="btn btn-primary d-flex align-items-center gap-2 px-4 py-2 rounded-3 fw-semibold">
              <Network size={20} />
              Computer Networks
              <ArrowRight size={16} />
            </Link>
            <Link to="/login" className="btn btn-outline-light d-flex align-items-center gap-2 px-4 py-2 rounded-3 fw-semibold">
              <Brain size={20} />
